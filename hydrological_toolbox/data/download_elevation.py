...
if __name__ == "__main__":
    ...
    # locations = daily_flood[['LAT', 'LON']].drop_duplicates()
    # d = download_altitude(locations, lat='LAT', lon='LON')
    height_usc = download_altitude(locations=[[34.00055556, -81.03472222]])
    print(height_usc)
...
#     exit()
#
#     somewhere_eastern = (50.41635777785, 14.9198269444)
#     somewhere_eastern_ground_truth = 217
#
#     somewhere_south_western = (-50.416357777855, -14.9198269444)
#     gt_for_somewhere_south_western = 217
#
#     columbia_sc = (34.0007, -81.0348)
#     columbia_sc_height = 90
#     downloader = AltitudeDownloader.from_list(columbia_sc, local_dir='/Users/hl774x/Documents/test_download_3/')
#     find = downloader.download()
#     # downloader.download_link()
#     # find = downloader.look_up_altitude(*somewhere_south_western)
#     print(find)
#     exit()
#
#     #
# # def strectcher(dim_1_min: Union[float, int],
# #                dim_1_max: Union[float, int],
# #                dim_2_min: Union[float, int],
# #                dim_2_max: Union[float, int]):
# #     """
# #     Because the data source actually organize the data with integer latitude and longitude
# #     Hence we need to stretch a box to the nearest integer.
# #     Apparently, the new box must be covering the older one.
# #     """
# #
# #     def shift_right(numeral):
# #         if isinstance(numeral, int):
# #             return numeral
# #         if numeral >= 0:
# #             return floor(numeral) + 1
# #         if numeral < 0:
# #             return floor(numeral)
# #
# #     def shift_left(numeral):
# #
# #         if isinstance(numeral, int):
# #             return numeral
# #         if numeral >= 0:
...
# #             return floor(numeral)
# #
# #     dim_1_min = shift_left(dim_1_min)
# #     dim_2_min = shift_left(dim_2_min)
# #     dim_1_max = shift_right(dim_1_max)
# #     dim_2_max = shift_right(dim_2_max)
# #
# #     return dim_1_min, dim_1_max, dim_2_min, dim_2_max
#
# #
# # import struct
# #
...
# # n = 24 * 60 + 58.888
# # e = 55 * 60 + 11.377
# # print(get_sample(fn, n, e))
#
#
#
#     #
#     # with gzip.open(os.path.join(local_temp_dir, temp_name), 'rb') as unzipper:
#     #     content = bytearray(unzipper.read())
#     #     print(decompress(content))
#         # unzipper.(os.path.join(local_temp_dir, temp_name.replace('.gz', '')))
#
#
#
#
#
#     # try:
#     #     downloaded_content = requests.get(web_url).content
...
#     #
#     #
#     # good_link = 'https://s3.amazonaws.com/elevation-tiles-prod/skadi/N32/N32W080.hgt.gz'
#     # o = requests.get(good_link)
#     # print(o.content)
#     #
#     # print(o.status_code)
#     # print(o)
#
# # download_links = generate_links_for_downloading(daily_flood)
# # download_link(links=download_links, local_temp_dir='/Users/hl774x/Documents/test_download/')
#
# # columbia_sc = (34.0007, -81.0348)
# # columbia_sc_height = 89
#
#
# # charleston_sc = (32.7765, -79.0911)
# # charleston_sc_height = 6
#
# charleston_sc = (33.61461929, -79.03608676)
# charleston_sc_height = 4
#
#
# from functools import partial
# # _look_up_altitude = partial(look_up_altitude, num_rows=3601)
# # _look_up_altitude = partial(look_up_altitude, num_rows=1201)
#
# # height_columbia = _look_up_altitude(*columbia_sc, '/Users/hl774x/Documents/test_download/')
# # height_charleston = _look_up_altitude(*charleston_sc, '/Users/hl774x/Documents/test_download/' )
#
# print(height_columbia)
# print(f'should be {columbia_sc_height}')
# print(height_charleston)
# print(f'should be {charleston_sc_height}')
# # links = 'https://s3.amazonaws.com/elevation-tiles-prod/skadi/N32/N32W080.hgt.gz'
# # download_link(links, '/Users/hl774x/Documents/')
#
# exit()
#
# import pandas as pd
...
# daily_flood_file = resource_stream('asset.sample_data_sc', 'GAGE-20110101-20161231-SC.parquet')
# daily_flood = pd.read_parquet(daily_flood_file)
# locs = daily_flood[['LAT', 'LON']].drop_duplicates().reset_index(drop=True)
#
# links = generate_links_for_downloading(locs)
# for i in links:
#     print(i)
#
# exit()
...
#
# """
# /Users/hl774x/PycharmProjects/spatial_bayes/venv/bin/python /Users/hl774x/PycharmProjects/spatial_bayes/data/util.py
# curl -s -o spool/N41/N41E009.hgt.gz.temp https://s3.amazonaws.com/elevation-tiles-prod/skadi/N41/N41E009.hgt.gz && mv spool/N41/N41E009.hgt.gz.temp spool/N41/N41E009.hgt.gz
# gunzip spool/N41/N41E009.hgt.gz 2>/dev/null || touch spool/N41/N41E009.hgt
# gdal_translate -q -co TILED=YES -co COMPRESS=DEFLATE -co ZLEVEL=9 -co PREDICTOR=2 spool/N41/N41E009.hgt cache/N41/N41E009.tif 2>/dev/null || touch cache/N41/N41E009.tif
# curl -s -o spool/N41/N41E010.hgt.gz.temp https://s3.amazonaws.com/elevation-tiles-prod/skadi/N41/N41E010.hgt.gz && mv spool/N41/N41E010.hgt.gz.temp spool/N41/N41E010.hgt.gz
# gunzip spool/N41/N41E010.hgt.gz 2>/dev/null || touch spool/N41/N41E010.hgt
# gdal_translate -q -co TILED=YES -co COMPRESS=DEFLATE -co ZLEVEL=9 -co PREDICTOR=2 spool/N41/N41E010.hgt cache/N41/N41E010.tif 2>/dev/null || touch cache/N41/N41E010.tif
# rm spool/N41/N41E009.hgt spool/N41/N41E010.hgt
# gdalbuildvrt -q -overwrite SRTM1.vrt
# """
#
# result = download_tiles(*[1,5,-10,-2])
# print(result)
#
#
#
